...
export declare function buildCondition(
  extension: string,
  type: string,
  data: Uint8Array
): Condition;
...
export declare function conditionToAddress(
  chainId: ChainId,
  cond: Condition
): Address;
...
export declare function multisignatureIdToAddress(
  chainId: ChainId,
  multisignatureId: number
): Address;
export declare function escrowIdToAddress(
  chainId: ChainId,
  escrowId: number
): Address;
export declare function electionRuleIdToAddress(
  chainId: ChainId,
  electionRule: number
): Address;
