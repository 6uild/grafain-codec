...
export declare function encodeBnsAddress(
...
export declare function appendSignBytes(
  bz: Uint8Array,
  chainId: ChainId,
  nonce: Nonce
): SignableBytes;
...
export declare function isConfirmedWithSwapClaimOrAbortTransaction(
  tx: ConfirmedTransaction<UnsignedTransaction>
): tx is ConfirmedTransaction<
  (SwapClaimTransaction | SwapAbortTransaction) & WithCreator
>;
