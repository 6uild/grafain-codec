...
function parseBaseTx(tx: codecImpl.grafain.ITx, sig: FullSignature, chainId: ChainId): UnsignedTransaction {
...
export function parseTx(tx: codecImpl.grafain.ITx, chainId: ChainId): SignedTransaction {
